...
- No magic numbers or strings, use named constants instead.
- When suggesting changes, provide clear reasoning and benefits for the change.
- Be careful when batch editing, you tend to overrun your context window and miss important details.
...
## Useful Commands:
- To run tests, use `./bin/rails test` from within the project directory.
- We're usingn rbenv to manage ruby environments, it should already be initialised for this project.

## Human Shorthand:
- LGTM = "Looks Good To Me"
- Not Shit = "Reasonably good"