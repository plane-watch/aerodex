...
module Source
  module Aircraft
    # Source records for aircraft from CASA (Civil Aviation Safety Authority, Australia).
    #
    # CASA is the Australian government authority responsible for aircraft registration.
    # This source is considered highly reliable for Australian-registered aircraft (VH-XXX).
    class CASAAircraftSource < AircraftSource
      # Default country code for CASA registrations
      COUNTRY_CODE = 'AU'
